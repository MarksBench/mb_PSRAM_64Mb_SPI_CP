"""
mb_PSRAM_64Mb_SPI_CP.py

Very Simple CircuitPython module/driver for Espressif 64Mbit SPI PSRAM
...
class mb_PSRAM_64Mb_SPI_CP:
    ...
    def __init__(self, spi, cs):
        ...
        self.cs.value = True # According to the datasheet, the device needs /CE high first
        time.sleep(0.0002) # Device needs 150us and a user-issued reset operation to complete its self-init
        self.cs.value = False
    ...
    def read_byte(self, address):
        ...
        self.spi.readinto(self.value_read)
        self.cs.value = True
